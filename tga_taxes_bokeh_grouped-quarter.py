...
pivot_df = pivot_df.groupby(pd.Grouper(freq='Q')).sum()

p = figure(title='TGA Taxes : grouped by quarter', sizing_mode='stretch_both', x_axis_type='datetime', x_axis_label='record_date', y_axis_label='amt')
